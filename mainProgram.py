...
# load citra RGB (BGR)
img = cv.imread("/home/pcsistem/Documents/carlo_ojd_ml/test images/AA5627JT.jpg")
...
if index_chars_candidate == []:
    ...
    model = keras.models.load_model('/home/pcsistem/Documents/carlo_ojd_ml/my_model.keras')
